...
#   persist-install remove apk <package>           - Remove APK package from persistence
#   persist-install remove pip <package>           - Remove pip package from persistence
...
install_pip() {
    ...
    # Install packages (with --break-system-packages for PEP-0668 compatibility)
